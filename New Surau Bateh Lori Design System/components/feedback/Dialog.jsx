...
export function Dialog({ open = true, title, description, children, footer, onClose, width = 460, inline = false }) {
  if (!open) return null;
  return (
    <div style={{ position: inline ? 'relative' : 'fixed', inset: 0, display: 'grid', placeItems: 'center', zIndex: 50,
